...
<body>
    <h1 style='margin:5px; padding:10px;'>Choose a model title to see more details</h1>
    <b style='margin:5px; padding:10px;'>Select a model name: </b>
        ...
        <select id="select">
            <?php 
                ...
                for ($i=0; $i <= count($data); $i++)                                  
                    ...
                    // SEND THIS TO THE CONTROLLER VIA JSON_ENCODE($DATA)
            ?>
        </select>
    </form> 
    ...
    $(document).ready(function(){
        $("#select").change(function () {
            // Debug
            var model = $(this).val();
            console.log('Weapon Model:', model, 'has been selected');
            ...
            $("select option:selected").each(function () {              
                ...
                str += "<div><b>Weapon: </b> "+ $(this).text() + "</div>" + "</br>";
                // Debug
                ...
                var modelUrl = "../application/model/modelWeaponDetails.php?modelTitle=" + selection;
                // Debug
                console.log('URL to PHP Model is:', modelUrl);
                ...
                $.getJSON(modelUrl, function(json) {
                  ...
                  for (var i=0; i<json.length; i++) {
                      ...
                      str +=
                        ...
                        "<img width='300px' src = '../assets/images/gallery/" + json[i].modelTitle + ".png'></img>" +
                        "</div>";
                  }
